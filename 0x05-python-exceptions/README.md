My Python Project, 0x05. Python - Exceptions by Edet Isong
...
Create three C functions that print some basic info about Python lists, Python bytes an Python float objects.Python lists:
